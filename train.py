...
message = tk.Label(window, text="Face-Recognition" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
copyWrite.insert("insert", "Developed by Master3I","", "TEAM", "superscript")
